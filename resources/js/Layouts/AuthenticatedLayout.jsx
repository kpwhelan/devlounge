...
export default function Authenticated({ user, header, children }) {
    ...
    return (
        <div className="min-h-screen bg-devlounge-background">
            <nav className="bg-devlounge-background border-b border-gray-100">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink href={route('dev-connect')} active={route().current('dev-connect')}>
                                    Dev Connect
                                </NavLink>
                            </div>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink href={route('dev-connect')} active={route().current('dev-connect')}>
                            Dev Connect
                        </ResponsiveNavLink>
                    </div>
